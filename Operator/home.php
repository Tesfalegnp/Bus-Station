...
<head>
    ...
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
        ...
        <?php
             include 'header_operator_home.php';
        ?>
<body>
<center>
    ...
    <style>
       ...
       <span>
         <a href="Operator_Register.php" class="btn btn-outline-primary btn-lg" style="margin-right:100px">
          <span class="glyphicon glyphicon-pencil"></span> <br>Register Operator
        </a>
       </span>
       <span>
         <a href="Association_Register.php" class="btn btn-outline-success btn-lg">
          <span class="glyphicon glyphicon-plus-sign"></span> <br>Register Association Manager
        </a>
       </span>
