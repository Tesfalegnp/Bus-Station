...
<body>
<div class="box">
    <form action="Association_Register.php" method="POST">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $db->prepare("INSERT INTO association (firstname, lastname, phonenumber, email, username, password, gender) VALUES (?, ?, ?, ?, ?, ?, ?)");
