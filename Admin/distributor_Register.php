...
<body>
<div class="box">
    <form action="distributor_Register.php" method="POST">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $db->prepare("INSERT INTO distributor (firstname, lastname, phonenumber, email, username, password, gender) VALUES (?, ?, ?, ?, ?, ?, ?)");
